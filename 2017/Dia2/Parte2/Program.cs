    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < rompecabezas.GetLength(0); i++)
            {
                ...
                {
                    for (int k = 0; k < rompecabezas.GetLength(1); k++)
                    {
                        if(rompecabezas[i,j] != rompecabezas[i,k])
                        {
                            if (rompecabezas[i, j] % rompecabezas[i, k] == 0) divisiones.Add(rompecabezas[i, j] / rompecabezas[i, k]);
                        }
                    }
                }
            }

            divisiones.ForEach(x => resultado += x);
